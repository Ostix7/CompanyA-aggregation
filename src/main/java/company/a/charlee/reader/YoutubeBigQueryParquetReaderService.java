...
@Service
public class YoutubeBigQueryParquetReaderService extends AbstractBigQueryParquetReaderService {

    public YoutubeBigQueryParquetReaderService(
            YoutubeProcessingService youtubeProcessor,
            @Qualifier("bigQueryForYoutube") BigQuery bigQuery,
            ProcessedFileRepository processedFileRepository) {
        super(youtubeProcessor, bigQuery, processedFileRepository);
    }
